...
for image in range(0 ,8):
    capivara_superficie = pygame.image.load(f'assets/capivara/andando/tile00{image}.png')
...
pygame.time.set_timer(novo_gamba_timer, 1250)
...
while True:
    ...
    index_capivara += 0.15
    capivara_supe = capivara_lista_imagens[int(index_capivara)]
